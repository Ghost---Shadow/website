...
<h2 id="basics-for-those-who-were-sleeping-in-class">Basics for those who were sleeping in class</h2>
...
<h2 id="trick-1-a-grammar-that-can-sort-numbers">Trick 1: A grammar that can sort numbers</h2>
...
<h2 id="trick-2-radix-sort-in-a-context-sensitive-grammar">Trick 2: Radix sort in a context-sensitive grammar</h2>
...
<Table striped highlightOnHover withBorder withColumnBorders>
  <tbody>
    ...
    <tr>
      <td>Advancing one cell</td>
      <td>O(log n)</td>
    </tr>
    <tr>
      <td>Cells traversed</td>
      <td>2n</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Space</td>
      <td>n + O(log n) — still linear, still LBA-legal</td>
    </tr>
  </tbody>
</Table>
...
<h2 id="trick-3-the-backspace-loophole">Trick 3: The backspace loophole</h2>
...
<h2 id="trick-4-a-dfa-as-a-rom">Trick 4: A DFA as a ROM</h2>
...
*Original conversation: [claude.ai/share/67dbb2a6-441c-4c87-b34a-5df0351630ab](https://claude.ai/share/67dbb2a6-441c-4c87-b34a-5df0351630ab)*
